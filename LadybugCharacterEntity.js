...
(function () {
    ...
    Entity.prototype.initUserInput = function () {
        ...
        this.core.world.add({
            ...
            perform: function () {
                if (that.core.inputs[newgame.InputTypes.RIGHT]) {
                    body.accelerate(3, 0, 0);
                }
                if (that.core.inputs[newgame.InputTypes.LEFT]) {
                    body.accelerate(-3, 0, 0);
                }
                if (that.core.inputs[newgame.InputTypes.UP]) {
                    body.accelerate(0, -3, 0);
                }
                if (that.core.inputs[newgame.InputTypes.DOWN]) {
                    body.accelerate(0, 3, 0);
                }
